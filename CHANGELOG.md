...
## [9.0.0](https://github.com/sahinf/neorg/compare/v8.6.0...v9.0.0) (2024-06-11)
...
* **selection_popup:** modernize code of selection popup ([310f3a4](https://github.com/sahinf/neorg/commit/310f3a484d3d98b0d05650a38407dcaa7f090b96))
...
* add `traverse-link` Neorg mode ([#1170](https://github.com/sahinf/neorg/issues/1170)) ([ed25267](https://github.com/sahinf/neorg/commit/ed25267eec3b08a3de8bdb4b55243f869ea4b8fd))
* add basic build.lua ([efac9eb](https://github.com/sahinf/neorg/commit/efac9eb8c16cfe5cd1a45705d2add4eca749e63f))
* add LaTex rendering for inline equations ([#1133](https://github.com/sahinf/neorg/issues/1133)) ([b5393e8](https://github.com/sahinf/neorg/commit/b5393e8bdcf704f660fa86cace89033c5fc95504))
...
* allow arguments for `:Neorg generate-workspace-summary` ([#1156](https://github.com/sahinf/neorg/issues/1156)) ([46741ed](https://github.com/sahinf/neorg/commit/46741ede577392f36cad1cb8c8e6029fabb729f6))
* allow nested workspace summaries ([#1144](https://github.com/sahinf/neorg/issues/1144)) ([a923055](https://github.com/sahinf/neorg/commit/a9230559fb6871f1f62996f8e862876169432f08))
...
* **concealer:** add ability to disable spell checking in code blocks ([316403a](https://github.com/sahinf/neorg/commit/316403ad1cbb665e7838f596384d44b1649f6c1b))
* **concealer:** add config for concealing numeric footnote title to superscript ([2a6fc9c](https://github.com/sahinf/neorg/commit/2a6fc9c808f6d643bf7c2f911a767e4aac500560))
* **concealer:** add configuration for hrule start and end position ([3db316a](https://github.com/sahinf/neorg/commit/3db316a33838eb0875eacd659af9d49bbd4aef39))
...
* **esupports.hop:** add open mode for external link target ([#1072](https://github.com/sahinf/neorg/issues/1072)) ([851a3a2](https://github.com/sahinf/neorg/commit/851a3a2b3cea5335fca233273d3c8861a017da14))
...
* **hop:** feed wslview with decoded link ([c3b9653](https://github.com/sahinf/neorg/commit/c3b965340f380740a12432536d2b23ee6c7564f9))
...
* **keyinds:** add keybind for entering link traversal mode ([#1177](https://github.com/sahinf/neorg/issues/1177)) ([8cf5205](https://github.com/sahinf/neorg/commit/8cf52058fb7e9c3057882430ade90be5bdfb3a94))
...
* **metagen:** allow falling back to the default template functions ([#1079](https://github.com/sahinf/neorg/issues/1079)) ([8200ebc](https://github.com/sahinf/neorg/commit/8200ebc5a5730a14efa2e47751a43539c8a16fb5))
* **metagen:** customize timezone and its format ([b458149](https://github.com/sahinf/neorg/commit/b4581496328d47ab7912148ec030dcb3ec1951c4))
* **metagen:** more precise timestamp with HH:MM:SS and timezone ([#1052](https://github.com/sahinf/neorg/issues/1052)) ([a8f7a9e](https://github.com/sahinf/neorg/commit/a8f7a9eeef5c22eac626e7533eeee0ac9def72ad))
* modify deps.json to have proper version constraints ([5e9a3ef](https://github.com/sahinf/neorg/commit/5e9a3ef798726fd2001d1596e6134b03f331a333))
* option to inject specific metadata instead of defaults ([#1128](https://github.com/sahinf/neorg/issues/1128)) ([5509079](https://github.com/sahinf/neorg/commit/55090798a2eed2dd00fc1b2774bc6bf309a3bd0b))
* prefix all keybind descriptions with "neorg" for discoverability ([15c24cd](https://github.com/sahinf/neorg/commit/15c24cdb264807b09e9281e2d72b324145da1d57))
...
* **selection_popup:** allow keybinds to be processed from another buffer ([603b633](https://github.com/sahinf/neorg/commit/603b633b8df231fe37a338856b1dea7cd955a969))
* **summary:** add strategy which uses workspace subfolders as category ([aa8e66d](https://github.com/sahinf/neorg/commit/aa8e66dd40c07a4de58f9ed93f27ab4dac9a241c))
...
* support dotrepeat for `promo` and `todo_items` ([#1105](https://github.com/sahinf/neorg/issues/1105)) ([2c43e6b](https://github.com/sahinf/neorg/commit/2c43e6b3252af198973cbe91f8fa7a762ff61a77))
...
* **toc:** add config for enabling synchronized cursorline in toc window ([d3cbb45](https://github.com/sahinf/neorg/commit/d3cbb45b66c865b1b92b5f8b2dbd5a5fff7f1a2f))
* **toc:** add toc item filter ([#1195](https://github.com/sahinf/neorg/issues/1195)) ([5c42084](https://github.com/sahinf/neorg/commit/5c420844227c75390cc9fdf6047bfc49466169d9))
* **toc:** auto adjust toc vsplit width upon creation ([81f6330](https://github.com/sahinf/neorg/commit/81f6330af951e89f98e8468d23a648fc32acdd2f))
...
* **toc:** enable folding in toc ([218e7eb](https://github.com/sahinf/neorg/commit/218e7ebbce010846c5ed6da647264c556c6a7ad4))
* **toc:** faster toc generation ([0171df1](https://github.com/sahinf/neorg/commit/0171df1d0f8a6db254020e8b02ac576188ffad23))
* **toc:** support one ToC per tabpage ([d8a456b](https://github.com/sahinf/neorg/commit/d8a456b7fa1b9d860fc36750b6e9a200a8eff5f3))
* **toc:** support todo status ([4ac077b](https://github.com/sahinf/neorg/commit/4ac077b1f19efe63fcec4e6c744bc6a68dfc7f6a))
* **toc:** sync cursor from ToC to content buffer ([47e7c86](https://github.com/sahinf/neorg/commit/47e7c86877aaae4d85c1a2add166ad6c15b8add4))
* **toc:** sync toc cursor after creating toc, scroll content to center when previewing ([cfcb51e](https://github.com/sahinf/neorg/commit/cfcb51ea9a403ee7223e49d4afb0142d6d5e1659))
...
* **`:h neorg`:** make link point to correct line in specs ([#1092](https://github.com/sahinf/neorg/issues/1092)) ([e20d032](https://github.com/sahinf/neorg/commit/e20d032ea3c485fc499f4dbc4bf7ce6afd6767ba))
* `folke/todo-comments.nvim` comments highlighting (again) ([#1094](https://github.com/sahinf/neorg/issues/1094)) ([d8e2c8e](https://github.com/sahinf/neorg/commit/d8e2c8e309c05a7db4ca84fc1216be38cf6a010f))
* `update-metadata` would fail to work with several parse trees in the document ([#1234](https://github.com/sahinf/neorg/issues/1234)) ([5a44d3f](https://github.com/sahinf/neorg/commit/5a44d3ffbd3b4fff762f8b2712ab1cfd16cff016))
* **action:** run lint action against pr head ([f367396](https://github.com/sahinf/neorg/commit/f36739620410917a3119ee4299894c353a0d88af))
...
* **autocommands:** pass correct buffer id ([941119d](https://github.com/sahinf/neorg/commit/941119d48a5e354cfbed24a4b314bb4eb401a75b))
...
* **build:** attempt to fix build script by deferring code execution ([fb45f83](https://github.com/sahinf/neorg/commit/fb45f836da9dd43940c3fdd182e8255bbce9d9dc))
...
* **calendar:** call `os.date` twice to generate correct weekday ([#1058](https://github.com/sahinf/neorg/issues/1058)) ([61fb605](https://github.com/sahinf/neorg/commit/61fb60508516b224ec78666187e70074397b37f8))
* **calendar:** display weekdays based on `nvim_strwidth` ([5eadb3c](https://github.com/sahinf/neorg/commit/5eadb3cce8ab490222d12dfbb5c86372c89a5773))
* **calendar:** use `nvim_strwidth` for month names as well ([a081397](https://github.com/sahinf/neorg/commit/a0813979663d5e55c481bb557c250b551042d115))
...
* **concealer:** avoid conflict between preset and custom icons ([9a0aab0](https://github.com/sahinf/neorg/commit/9a0aab039b174625bfc4ff708ba32f3fc5713649))
* **concealer:** BufNewFile-&gt;FileType, get winid of bufid when rendering ([c0983ca](https://github.com/sahinf/neorg/commit/c0983ca60f02e1a65e5990593726e57678e03c4a))
* **concealer:** do not render on range change if concealer is disabled ([9b0c31a](https://github.com/sahinf/neorg/commit/9b0c31a5179f3881f9ff2350da22c9a5a11f32ab))
* **concealer:** don't rerender at `conceallevel` change when disabled ([#1068](https://github.com/sahinf/neorg/issues/1068)) ([63a7a10](https://github.com/sahinf/neorg/commit/63a7a101387550a220186cab7e85df15635f3356))
...
* **concealer:** more precise anticonceal feature detection ([#1056](https://github.com/sahinf/neorg/issues/1056)) ([b0117a4](https://github.com/sahinf/neorg/commit/b0117a40675398cb6b7f0967a52e148d5ddb6f42))
* **concealer:** revert a wrong fix, make luacheck ignore empty if branch instead (supercedes [#1080](https://github.com/sahinf/neorg/issues/1080)) ([0c82917](https://github.com/sahinf/neorg/commit/0c82917b89a187662cf8c1f5fc3a17153866df9b))
...
* **config:** delete `neovim_version` as it is no longer in use ([00f9a62](https://github.com/sahinf/neorg/commit/00f9a628683b7b3f738e1d1d1a79d517c26b6ff5))
* **config:** fix luajit version detection ([237abac](https://github.com/sahinf/neorg/commit/237abac43a38e4aa770bb5819f30b3d38ae5f392))
...
* **core:** assign custom field ([4b057ad](https://github.com/sahinf/neorg/commit/4b057ad071f0e395fb1e983c9611913e9b46108f))
* **dirman:** add `raw_path` option to work with arbitrary filetype ([#1143](https://github.com/sahinf/neorg/issues/1143)) ([0c9f5de](https://github.com/sahinf/neorg/commit/0c9f5dea0cfe8b7c3d38f26651d82624079774ed))
...
* **dirman:** open index file in default workspace only if it exists ([d1bda3c](https://github.com/sahinf/neorg/commit/d1bda3caf7d73ec93bed125d2d76ba32ce897789))
* **dirman:** properly escape directories and filenames ([#1232](https://github.com/sahinf/neorg/issues/1232)) ([e1f5556](https://github.com/sahinf/neorg/commit/e1f5556bfbe50cbae262dffc35f376f7469f68cf))
...
* don't autoload `core.neorgcmd` nor `core.keybinds` as dependencies of other modules ([#1051](https://github.com/sahinf/neorg/issues/1051)) ([62ba931](https://github.com/sahinf/neorg/commit/62ba93130eb795ccc2133841ce0e541f8bc51eb7))
...
* don't use deprecated `query.get_node_text()` call ([#1067](https://github.com/sahinf/neorg/issues/1067)) ([7248c34](https://github.com/sahinf/neorg/commit/7248c347704d658daf0fa0a84706c120e92eb1a5))
...
* error in loading preventing wiki from generating ([2745ee1](https://github.com/sahinf/neorg/commit/2745ee1371c1029171bb98f2d9fb258e688d2c20))
...
* **hop:** fix range check across lines ([1038016](https://github.com/sahinf/neorg/commit/10380167975732444f21c882e522d15b0ec55b34))
...
* issue a more friendly error message when user loads tempus pre-Neovim `0.10.0` ([#1035](https://github.com/sahinf/neorg/issues/1035)) ([333a1fd](https://github.com/sahinf/neorg/commit/333a1fd67aad3dee49305b0278bd59f8ae740f13))
...
* **journal:** toc reset month & add link indent ([#1165](https://github.com/sahinf/neorg/issues/1165)) ([16af444](https://github.com/sahinf/neorg/commit/16af444ef804aa7f099c7a5ae03640dfc2b60303))
* **journal:** value assigned to variable current_quarter is unused ([0e88151](https://github.com/sahinf/neorg/commit/0e8815116b08bfbceb2b36a8c82d81005e2596e0))
...
* **latex:** Want image integration ([a80c025](https://github.com/sahinf/neorg/commit/a80c025b231a6acd925d625d6d9ea302bc20bd49))
...
* **luacheck:** setting non-standard global variables in latex renderer module ([#1176](https://github.com/sahinf/neorg/issues/1176)) ([3f4b279](https://github.com/sahinf/neorg/commit/3f4b279d7505ac854fcd31d1aad24991542ea5d8))
...
* **meta:** fix treesitter deprecation warning ([#1104](https://github.com/sahinf/neorg/issues/1104)) ([#1130](https://github.com/sahinf/neorg/issues/1130)) ([5205f3f](https://github.com/sahinf/neorg/commit/5205f3f1ed23545a3015021be11d35a012e3b02a))
* **modules:** Check the right config key in module.wants ([8b25435](https://github.com/sahinf/neorg/commit/8b25435e8bc60f9e6f665b3a28870d64d20f2b59))
* **neorg.norg:** clarify horizontal line syntax ([#1230](https://github.com/sahinf/neorg/issues/1230)) ([e35bf90](https://github.com/sahinf/neorg/commit/e35bf907533281a6c641505eae3bb42100d7b5a0))
...
* nobody figured it out so away it goes :) ([7b3e794](https://github.com/sahinf/neorg/commit/7b3e794aa8722826418501608c8a3ffe4e19ea30))
...
* record that module `upgrade` requires at least 1 arg ([#1207](https://github.com/sahinf/neorg/issues/1207)) ([51f55f5](https://github.com/sahinf/neorg/commit/51f55f5c6d54fa86fdaae805b55ca88aa9607c37))
...
* remove LaTeX renderer and image.nvim integration from `core.defaults` ([5a88bcb](https://github.com/sahinf/neorg/commit/5a88bcbf60590348e4196493c9c7642f23ba21d7))
...
* **summary:** escape ws_root special characters ([#1012](https://github.com/sahinf/neorg/issues/1012)) ([32abc0d](https://github.com/sahinf/neorg/commit/32abc0da29dd5bf4b42d340810b64754fd7a37b8))
* **summary:** set correct indentation for list items ([120fb52](https://github.com/sahinf/neorg/commit/120fb52f5fe21c43fcc7285bac4a9bce8a54a6ec))
...
* **toc:** clear title after assigning prefix ([f446645](https://github.com/sahinf/neorg/commit/f4466457396717d10d2d235d019e0a80e1770087))
* **toc:** fix all stylua errors ([ae38baf](https://github.com/sahinf/neorg/commit/ae38baf90a319488b726ed25166fc00641b3e0ce))
* **toc:** get window id on the fly to avoid assertion errors ([1b0ab75](https://github.com/sahinf/neorg/commit/1b0ab75e8e57b08bc981e0d72fe928b0fff34fe2))
* **toc:** handle buf close ([985364f](https://github.com/sahinf/neorg/commit/985364f561518502cc002494db4d48ec92b00d80))
* **toc:** handle buf close ([2d65f6c](https://github.com/sahinf/neorg/commit/2d65f6cf7a0f40b9a474e17bc347255514dbde0e))
* **toc:** listen cursormoved for all norg files ([19bff13](https://github.com/sahinf/neorg/commit/19bff133659c16973e52546f54a13469bfecb1b6))
* **toc:** preserve heading hierarchy ([#1053](https://github.com/sahinf/neorg/issues/1053)) ([1c1060f](https://github.com/sahinf/neorg/commit/1c1060f0d187cd0939b05c1310bb58911e84bc22))
* **toc:** stop synching cursor when content window is hidden ([15ed981](https://github.com/sahinf/neorg/commit/15ed981858658796b698f6fc204f1378eef4b01d))
...
* **typecheck:** fix type errors caused by autoformat ([3f531c3](https://github.com/sahinf/neorg/commit/3f531c362d07d52c4956520e3798e9cfb5aeabdf))
...
* **utils:** don't dotrepeat insert mode actions ([#1111](https://github.com/sahinf/neorg/issues/1111)) ([969b3f1](https://github.com/sahinf/neorg/commit/969b3f106683c66ab685ecba2a67bf11cb806785))
...
* workspace summary ignore closed files and title field of metadata tag ([#1139](https://github.com/sahinf/neorg/issues/1139)) ([d081937](https://github.com/sahinf/neorg/commit/d081937a00e0f0c6966116428117e159a785abb5))
